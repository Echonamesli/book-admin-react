import { Input, Form, Button, Select, Space, Row, Col, Table, Image, Tooltip, TablePaginationConfig } from 'antd'
...
const COLUMNS = [
  ...
  },
  {
    ...
    width: 120,
    render: (text: string) => {
      return <Image alt = '' width={50} src={text} />
    }
  },
  {
    title: '作者',
...
export default function Home() {
  ...
  const columns = [...COLUMNS, {
    title: '操作', key: 'action', render: (_: any, row: any) => {
      return <Space>
        <Button type='text' onClick={handleBookEdit}>编辑</Button>
